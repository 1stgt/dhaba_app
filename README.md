...
## 🔐 Google Sheets Setup (Optional for Live Data)
...
├── google_sheets_client.py # Data layer (Mock + GSheets implementation)
├── utils.py                # Helper functions (QR Code generation)
├── requirements.txt        # Project dependencies
└── .streamlit/
    └── secrets.toml        # API credentials (keep private!)
```
